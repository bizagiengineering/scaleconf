/**
 * Raffle library for ScaleConf Colombia 2017
 *
 * @type {Function}
 * @author Edward J Morales
 */
var BizagiScaleConfRaffle = (function (options) {
    var self = this;
    self.properties = {
        names: [],
        callBack: {
...
$(document).ready(function () {
    ...
    var getNames = function () {
        ...
        return $.get("http://scaleconf.eastus2.cloudapp.azure.com:8080/api/registered/holder");
    };
    ...
    $.when(getNames()).done(function (names) {
        ...
        var bizagiRaffle = new BizagiScaleConfRaffle(options);
